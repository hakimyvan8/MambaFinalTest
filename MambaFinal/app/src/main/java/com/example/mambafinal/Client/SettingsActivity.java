...
public class SettingsActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        profileChangeTextBtn = (TextView) findViewById(R.id.settings_text);
        closeTextBtn = (Button) findViewById(R.id.close_settings);
        saveTextButton = (Button) findViewById(R.id.update_settings);
        securityQuestions =(Button) findViewById(R.id.security_qtn);
